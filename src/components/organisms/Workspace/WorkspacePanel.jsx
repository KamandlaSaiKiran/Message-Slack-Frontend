...
import { AlertTriangle, AlertTriangleIcon, Loader,MessageSquareTextIcon  } from "lucide-react";
...
export const WorkspacePanel = ()=>{
    ...
    if(isFetching){
        return(
            <div
            className="flex flex-col gsp-y-2 h-full items-center justify-center text-white">

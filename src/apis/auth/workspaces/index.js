...
export const fetchWorkspaceRequest = async ({token})=>{
    try{
        ...
        console.log('Respone in fetch Workspace request',response);
        return response?.data?.data;
    } catch(error){
...
export const fetchWorkspaceDetailsRequest = async ({workspaceId,token})=>{
    try{
        ...
        console.log('Error in fetching the workspace details request', error);
        throw error.response.data;
    }
}
...
export const updateWorkspaceRequest = async ({workspaceId,token})=>{
        try{
            ...
            console.log("Error in updating the workspace request",error);
            throw error.response.data;
        }
}